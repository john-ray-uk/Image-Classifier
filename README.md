...
It's taken me a week to code inbetween coursework and lectures, mainly involving me following (PyTorch's official beginner tutorial)[https://docs.pytorch.org/tutorials/beginner/blitz/cifar10_tutorial.html], which is an excellent 
introduction to Deep Learning, and modifying the GUI that I used for my (Newtonian Potential Simulator program)[] two weeks ago (as well as just borrowing some code from Stack Exchange).
